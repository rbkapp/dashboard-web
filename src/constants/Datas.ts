export default {
	...
	Types: [
		{ label: 'Motos', value: '1' },
		{ label: 'Veículo leve', value: '2', },
		{ label: 'Veículo pesado', value: '3', },
	],
	States: [
		{ label: 'Acre', value: 'AC' },
	...
	TypeRefunds: [
		{ label: 'Crédito conta EventX', value: '1' },
		{ label: 'Cartão de crédito', value: '2', },
		{ label: 'Conta bancária', value: '3', },
	],
	TypeAcounts: [
	...
	Ages: [
		{ value: '0', label: '', description: '', color: '#ffffff' },
		{ value: '1', label: 'L', description: 'Livre para todas as idades', color: '#00EE6D' },
		{ value: '2', label: '10', description: '10 anos ou mais', color: '#08A6FF' },
		{ value: '3', label: '12', description: '12 anos ou mais', color: '#DFC900' },
		{ value: '4', label: '14', description: '14 anos ou mais', color: '#EA8D02' },
		{ value: '5', label: '16', description: '16 anos ou mais', color: '#BC1C1C' },
		{ value: '6', label: '18', description: '18 anos ou mais', color: '#000000' },
	],
	Streamings: [
	...
	TypePlace: [
		{ label: 'Evento presencial', value: '1' },
		{ label: 'Evento online', value: '2', },
		{ label: 'Evento híbrido (presencial + online)', value: '3', },
	],
	TypePayments: [
	...
	StatusPayments: [
		...
		{ label: 'REEMBOLSADO', value: 'REFUND', },
		{ label: 'OUTRO', value: 'OTHER', },
	],
	SearchTypeTransactions: [
		{ label: 'ID da compra', value: '1' },
		{ label: 'Nome do comprador', value: '2', },
		{ label: 'CPF do comprador', value: '3', },
		{ label: 'e-mail do comprador', value: '4', },
	],
	SuportCategories: [
	...
	CategoriesSearchDates: [
		{ label: 'Hoje', value: '1' },
		{ label: 'Esta semana', value: '2', },
		{ label: 'Este mês', value: '3', },
		{ label: 'Todos', value: '0', },
	],
	CategoriesSearchPrices: [
		{ label: 'Até R$ 50,00', value: '1' },
		{ label: 'Até R$ 100,00', value: '2', },
		{ label: 'Até R$ 500,00', value: '3', },
		{ label: 'Todos', value: '0', },
	],
};